...
For the prebuilt vocabularies, I used `-include-256-bytes` for `50256`, `65536` & `100256` vocab sizes. I used `-include-utf8-bytes -exclude-other-bytes` for most of the others, and for `8000` and less vocabulary size I used `-include-extended-bytes -exclude-other-bytes`.
